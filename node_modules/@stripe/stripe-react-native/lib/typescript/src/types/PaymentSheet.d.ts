...
export declare enum NavigationBarStyle {
    /** Default style */
    Plain = "plain",
...
export type IntentConfiguration = {
     ...
     */
    confirmationTokenConfirmHandler?: (confirmationToken: ConfirmationTokenResult, intentCreationCallback: (result: IntentCreationCallbackParams) => void) => void;
    mode: Mode;
 ...
 */
export declare enum CustomPaymentMethodResultStatus {
