import { resendOtp, signupVerification } from "@/API";
...
export default function VerifyAccount() {
  ...
  const handleVerification = async () => {
    ...
    try {
      ...
      const response = await signupVerification({ identifier: email, otp });
      if (response.status.toString().includes("20")) {
      ...
      console.error(error);
      errorNotification("Verification failed. Please try again.");
    } finally {
      setLoading(false);
    }
  };
